    ...
    <div className="grid gap-4 md:grid-cols-2">
      {vendor.bestFor ? (
        <div className="rounded-[var(--radius-card)] border border-rule bg-surface p-5">
          <h2 className="font-heading text-sm font-semibold uppercase tracking-wide text-signal">
            Best for
          </h2>
      ...
      {vendor.editorVerdict ? (
        <div className="rounded-[var(--radius-card)] border border-rule bg-surface p-5">
          <h2 className="font-heading text-sm font-semibold uppercase tracking-wide text-warning">
            Editor verdict
          </h2>
